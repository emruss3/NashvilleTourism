with verified(slug,address,postal,phone,website,source_url) as (
  values
    ('grand-ole-opry-house','600 Opry Mills Drive','37214',null::text,'https://www.opry.com/','https://www.opry.com/plan-your-visit'),
    ('bluebird-cafe','4104 Hillsboro Pike','37215','615-383-1461','https://bluebirdcafe.com/','https://bluebirdcafe.com/contact/'),
    ('station-inn','402 12th Avenue South','37203','615-255-3307','https://stationinn.com/','https://stationinn.com/'),
    ('bridgestone-arena','501 Broadway','37203','615-770-2000','https://www.bridgestonearena.com/','https://www.bridgestonearena.com/contact-us')
)
...
with source as (
  ...
  values
    ('grand-ole-opry-house','https://www.opry.com/','https://www.opry.com/plan-your-visit'),
    ('bluebird-cafe','https://bluebirdcafe.com/','https://bluebirdcafe.com/contact/'),
    ('station-inn','https://stationinn.com/','https://stationinn.com/'),
    ('bridgestone-arena','https://www.bridgestonearena.com/','https://www.bridgestonearena.com/contact-us')
)
...
with source as (
  ...
  select p.id from public.places p where p.slug in ('grand-ole-opry-house','bluebird-cafe','station-inn','bridgestone-arena')
)
...
where p.slug in ('grand-ole-opry-house','bluebird-cafe','station-inn','bridgestone-arena')
