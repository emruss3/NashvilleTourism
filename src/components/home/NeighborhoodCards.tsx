 ...
 * flow on phones (no swiping), three equal landscape cards on desktop, and a
 * browse-all link. Each card is one link with a real, cleared photograph.
 */
...
export default function NeighborhoodCards() {
  ...
  return (
    <section className="section border-t border-paper-edge" aria-labelledby="neighborhoods-title">
      <div className="shell">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 text-[15px] text-ink-soft">Different neighborhoods. A closer Nashville.</p>
          </div>
          <Link
            href="/neighborhoods/"
            className="inline-flex min-h-11 items-center gap-1.5 text-sm font-semibold text-ink underline-offset-[0.2em] hover:underline"
          >
            ...
            <li key={hood.slug}>
              ...
              >
                <SmartImage
                  ...
                  ratio="aspect-[16/9] md:aspect-[5/4]"
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-3 p-4 sm:p-5">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 line-clamp-2 text-sm text-paper/85">{hood.summary}</p>
                  </div>
