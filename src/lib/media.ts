...
export const heroVideo: VideoAsset = {
  ...
  alt: 'A muted montage of the Nashville skyline, Lower Broadway rooftops, live music, and nightlife.',
  licence: 'BPH-owned media — user-authorized derivative, 2026-08-04',
};
...
export const images = {
  ...
  'hero/downtown-rooftop': {
    ...
    alt: 'Daytime rooftop overlooking Lower Broadway and downtown Nashville.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 2400,
    height: 1350,
  },
  'hero/live-music-night': {
    ...
    alt: 'Crowd watching a rooftop performance under red and blue stage lighting in downtown Nashville.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 2400,
    height: 1350,
  },
  ...
  'hub/honky-tonk-highway': {
    ...
    alt: 'A nighttime rooftop crowd overlooking downtown Nashville.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 1600,
    height: 1067,
  },
  ...
  'hub/live-music': {
    ...
    alt: 'A crowd gathered around a stage under dramatic lighting in downtown Nashville.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 1600,
    height: 1067,
  },
  ...
  'hub/tickets': {
    ...
    alt: 'A packed Nashville venue during a live performance.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 1600,
    height: 1067,
  },
  ...
  'hub/weekend': {
    ...
    alt: 'Golden-hour aerial of Nashville from Wedgewood-Houston.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 1600,
    height: 1067,
  },
  ...
  'neighborhood/downtown-broadway': {
    ...
    alt: 'A rooftop view down Lower Broadway in downtown Nashville on a bright day.',
    licence: 'BPH-owned media — user-authorized reuse on 2026-08-04',
    width: 1600,
    height: 1067,
  },
