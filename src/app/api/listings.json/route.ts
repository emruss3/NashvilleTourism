...
export function GET() {
  ...
  const payload = {
    ...
    licence: {
      ...
      note: 'Verification status is per record. "needs-recheck" records describe real places whose practical details await re-verification on the date shown. Live tour inventory is not included in this export; see /tours/.',
    },
